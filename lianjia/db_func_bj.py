...
class DBOperateSet(object):
    ...
    def select_community_by_condition(self, condition):
        cursor = self.__conn.cursor()
    ...
    def update_community_bj(self, p_name_py, direct_name, partition_url, partition_name):
        cursor = self.__conn.cursor()
    ...
    def update_community_bj_for_finish(self, community_id, flag, total_count):
        cursor = self.__conn.cursor()
